<template>
  <div class="bg bgperfect" >
    <div class="ptFont title">比赛规则</div>
    <back></back>
    <div class="center bgperfect" :style="{backgroundImage:'url('+bgUrl[now-1]+')'}"></div>
...
export default {
  ...
  created(){
    ...
    for(let i=1;i<=this.max;i++){
    	this.bgUrl.push(require(`../../static/imgs/demo/stepTxt${this.index}/step${i}.jpg`));
    }
